...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<OnboardingPage> _pages = [
    ...
    OnboardingPage(
      ...
      highlight: null,
      subtitle:
          'Este es un espacio para entender cómo estás hoy y ayudarte a entrar en el mood correcto para sentirte mejor.',
      icon: Icons.self_improvement_rounded,
    ),
    OnboardingPage(
      title: 'No es un examen.',
      highlight: null,
      subtitle: 'No hay respuestas buenas o malas.',
      icon: Icons.check_circle_outline_rounded,
    ),
    OnboardingPage(
      title: 'Solo respóndenos con honestidad.',
      highlight: null,
      subtitle:
          'Nos tomará menos de 5 minutos y ayudará a la IA a darte mejores recomendaciones.',
