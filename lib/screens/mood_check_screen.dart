...
import 'sleep_check_screen.dart';

class MoodCheckScreen extends StatefulWidget {
  const MoodCheckScreen({super.key, required this.onContinue});
...
class _MoodCheckScreenState extends State<MoodCheckScreen>
  ...
  final List<MoodOption> _moodOptions = [
    MoodOption(
      title: 'Bajo',
      description: 'Me siento triste o desanimado frecuentemente',
      icon: Icons.sentiment_dissatisfied_rounded,
      color: const Color(0xFF845EC2),
    ),
    MoodOption(
      title: 'Estable',
      description: 'Mi ánimo se mantiene equilibrado la mayor parte del tiempo',
      icon: Icons.sentiment_neutral_rounded,
      color: const Color(0xFF4ECDC4),
    ),
    MoodOption(
      title: 'Bueno',
      description: 'Generalmente me siento positivo y con buen ánimo',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        const Color(0xFF845EC2).withValues(alpha: 0.15),
                        const Color(0xFF4ECDC4).withValues(alpha: 0.2),
                      ],
                    ),
                    borderRadius: BorderRadius.circular(28),
                    border: Border.all(
                      color: const Color(0xFF845EC2).withValues(alpha: 0.4),
                      width: 2,
                    ),
                  ),
                  child: const Icon(
                    ...
                    children: [
                      ..._moodOptions.asMap().entries.map((entry) {
                        ...
                        return Padding(
                          ...
                          child: _buildMoodCard(option, index, isSelected),
                        );
                      }),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFF845EC2).withValues(alpha: 0.15),
  ...
  Widget _buildMoodCard(MoodOption option, int index, bool isSelected) {
