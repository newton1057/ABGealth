...
class FoodFactorsScreen extends StatefulWidget {
  const FoodFactorsScreen({super.key, required this.onContinue});

  final VoidCallback onContinue;

  @override
  State<FoodFactorsScreen> createState() => _FoodFactorsScreenState();
}

class _FoodFactorsScreenState extends State<FoodFactorsScreen>
  ...
  final List<FoodFactorOption> _factorOptions = [
    FoodFactorOption(
      title: 'Comer a deshoras',
      emoji: '⏰',
